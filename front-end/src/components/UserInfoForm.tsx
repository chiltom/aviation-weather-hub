...
const UserInfoForm = ({ user, setUser, theme }: ContextType): ReactElement => {
   ...
   * @param e 
   */
  const handleUserChangeRequest: FormEventHandler<
    HTMLButtonElement
  > = async (e) => {
    e.preventDefault();
    ...
    if (user !== null) {
      ...
      alert("Display name is already taken, please try again.");
    }
  };
  ...
  return (
    <>
      ...
      <Form data-bs-theme={theme} onSubmit={handleUserChangeRequest}>
