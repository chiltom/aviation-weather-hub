  ...
  return (
    <>
      ...
      <p>
        ...
        flight hazards, track your own workflow and tasklist for each shift, and
        grab METAR and TAF data from personalized lists of stored airports and
        cities, this application aims to streamline as much of the workload as
        possible.
      </p>
    </>
  );
